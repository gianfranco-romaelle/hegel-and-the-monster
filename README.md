...
The rank_bucket per cycle (1=reset-like, 2=partial, 3=group-like) tracks where the cycle sits in a J-class hierarchy of the compression semigroup — a finite sampled transformation semigroup, not a full algebraic decomposition.
